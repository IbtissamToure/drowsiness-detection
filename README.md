...
Model performance is moderate due to hardware limitations during training. Accuracy is expected to improve significantly with access to higher-compute environments and larger datasets.

## Dataset:
Dataset sourced from Kaggle. Due to size constraints, data files are not included in this repository.
